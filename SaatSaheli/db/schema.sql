...
-- Size ledger for R2 objects (storage quotas); see QuotaService.
CREATE TABLE public.media_assets (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    url character varying(1000) NOT NULL UNIQUE,
...
-- Private buyer <-> seller messages about items For Sale (see MessagingService).
CREATE TABLE public.conversations (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    seller_id bigint NOT NULL,
    buyer_id bigint,                              -- NULL = guest enquiry (see guest_* columns)
    ...
    item_link character varying(255),
    status character varying(255),
    last_preview character varying(200),
    ...
    seller_emailed_at timestamp(6) without time zone,
    buyer_emailed_at timestamp(6) without time zone,
    created_date timestamp(6) without time zone,
    CONSTRAINT uk_conversation_party_item UNIQUE (seller_id, buyer_id, target_type, target_id)
);
...
CREATE TABLE public.conversation_messages (
    ...
    sender_id bigint,                             -- NULL = guest
    sender_name character varying(255),
    body text NOT NULL,
    is_deleted boolean DEFAULT false NOT NULL,
    created_date timestamp(6) without time zone
);
CREATE INDEX idx_conversation_messages_conv ON public.conversation_messages (conversation_id, id);

--
-- Name: email_log; Type: TABLE; Schema: public; Owner: -
-- Audit row per outbound email attempt (SENT / FAILED / SKIPPED). Written by EmailService.
--
...
CREATE TABLE public.email_log (
    ...
    delivered_to character varying(500),
...
CREATE INDEX idx_email_log_related ON public.email_log (related_type, related_id);
