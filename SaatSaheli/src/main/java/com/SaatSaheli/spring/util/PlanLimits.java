...
public final class PlanLimits {
    ...
    /** Pages of a magazine issue that anonymous / Free readers may read before the gate. */
    public static final int MAGAZINE_PREVIEW_PAGES = 10;
    ...
    /** Read magazine issues past the free preview (books, articles, recipes, galleries are free for all). */
    public final boolean canReadFullMagazine;
    ...
    private PlanLimits(String plan, int maxBooks, int maxPagesPerBook, int maxImages,
                       ...
                       boolean canUseMarketChat, int maxForSaleItems, boolean canReadFullMagazine) {
        this.plan = plan;
        ...
        this.canReadFullMagazine = canReadFullMagazine;
    }
