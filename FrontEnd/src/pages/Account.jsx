  ...
  return (
    ...
    <div className="account-page">
      ...
      <div className="acct-profile-card">
        {profile?.displayName && (
          <button type="button" className="acct-share-corner" onClick={shareMyProfile} title={strings.account.shareProfile} aria-label={strings.account.shareProfile}>
            ...
            <span>{profileShared ? strings.account.shareProfileCopied : strings.common.share}</span>
          </button>
        )}
