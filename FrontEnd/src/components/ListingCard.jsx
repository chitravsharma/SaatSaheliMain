...
export default function ListingCard({ item, ownerActions = null, onMessage }) {
  ...
  const purchasable = !!userId && item.status === "ACTIVE" && item.priceAmount != null;
    ...
    <div className="mp-card">
      <div className="mp-card-images">
        ...
        {user && (
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill={faved ? "#dc2626" : "none"} stroke={faved ? "#dc2626" : "#fff"} strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 10-7.78 7.78L12 21.23l8.84-8.84a5.5 5.5 0 000-7.78z"/></svg>
          </button>
        )}
      </div>
